    ...
    private string BuildLargeTierProfile()
     {
        ...
        sb.AppendLine("- Plan internally, then act. You MAY include MULTIPLE tool calls in one response for independent operations — batch them where safe.");
        sb.AppendLine("- Avoid repeating a tool call with identical arguments — repeating it adds nothing.");
